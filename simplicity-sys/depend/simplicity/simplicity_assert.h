...
#define rustsimplicity_0_8_assert assert

/* rustsimplicity_0_8_debug_assert is for assertions to be removed in PRODUCTION mode.
 ...
 */
#define rustsimplicity_0_8_debug_assert(cond) do { if (!PRODUCTION_FLAG) { assert(cond); } } while(0)
