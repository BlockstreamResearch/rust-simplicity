...
void (*rustsimplicity_0_8_sha256_compression)(uint32_t* midstate, const uint32_t* block) = sha256_compression_portable;

/* For information purposes only.
 * Returns true if the sha256_compression implementation has been optimized for the CPU.
 * Otherwise returns false.
 */
bool rustsimplicity_0_8_sha256_compression_is_optimized(void) {
  return sha256_compression_portable != rustsimplicity_0_8_sha256_compression;
};
 ...
 *               's->len < 2^64;
 */
void rustsimplicity_0_8_sha256_bitstring(uint32_t* h, const bitstring* s) {
  ...
  rustsimplicity_0_8_assert(count == s->len);
