...
void (*rustsimplicity_0_6_sha256_compression)(uint32_t* midstate, const uint32_t* block) = sha256_compression_portable;
...
bool rustsimplicity_0_6_sha256_compression_is_optimized(void) {
  return sha256_compression_portable != rustsimplicity_0_6_sha256_compression;
};
...
void rustsimplicity_0_6_sha256_bitstring(uint32_t* h, const bitstring* s) {
  ...
  rustsimplicity_0_6_assert(count == s->len);
