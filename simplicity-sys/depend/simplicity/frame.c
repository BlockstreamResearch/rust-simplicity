 ...
 */                                                                                                                           \
uint_fast##size##_t rustsimplicity_0_4_read##bits(frameItem* frame) {                                                                 \
 ...
 */                                                                                                                           \
void rustsimplicity_0_4_write##bits(frameItem* frame, uint_fast##bits##_t x) {                                                        \
...
void rustsimplicity_0_4_read_buffer8(unsigned char* buf, size_t* len, frameItem* src, int n) {
  rustsimplicity_0_4_debug_assert(0 <= n && n < 16);
  *len = 0;
...
void rustsimplicity_0_4_write_buffer8(frameItem* dst, const unsigned char* buf, size_t len, int n) {
  rustsimplicity_0_4_debug_assert(0 <= n && n < 16);
  rustsimplicity_0_4_debug_assert(len < ((size_t)1<<(n+1)));
  for (size_t i = (size_t)1 << n; 0 < i; i /= 2) {
...
bool rustsimplicity_0_4_read_sha256_context(sha256_context* ctx, frameItem* src) {
  ...
  rustsimplicity_0_4_read_buffer8(ctx->block, &len, src, 5);
  compressionCount = rustsimplicity_0_4_read64(src);
...
bool rustsimplicity_0_4_write_sha256_context(frameItem* dst, const sha256_context* ctx) {
  rustsimplicity_0_4_write_buffer8(dst, ctx->block, ctx->counter % 64, 5);
  rustsimplicity_0_4_write64(dst, ctx->counter >> 6);
