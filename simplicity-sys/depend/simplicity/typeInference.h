 ...
 * for all the jets that can be created by 'rustsimplicity_0_7_callbac_decodeJet', and also the type 'TWO^256',
 ...
 */
typedef size_t (*rustsimplicity_0_7_callback_mallocBoundVars)(unification_var** bound_var, size_t* word256_ix, size_t* extra_var_start, size_t extra_var_len);
