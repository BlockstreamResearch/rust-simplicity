 ...
 */
extern bitcoinTransaction* rustsimplicity_0_8_bitcoin_mallocTransaction(const rawBitcoinTransaction* rawTx) {
 ...
 */
extern void rustsimplicity_0_8_bitcoin_freeTransaction(bitcoinTransaction* tx) {
 ...
 */
extern bitcoinTapEnv* rustsimplicity_0_8_bitcoin_mallocTapEnv(const rawBitcoinTapEnv* rawEnv) {
  ...
  *env = (bitcoinTapEnv){ .leafVersion = rawEnv->controlBlock[0] & 0xfe
  ...
  env->tapLeafHash = rustsimplicity_0_8_bitcoin_make_tapleaf(env->leafVersion, &env->scriptCMR);
 ...
 */
extern void rustsimplicity_0_8_bitcoin_freeTapEnv(bitcoinTapEnv* env) {
