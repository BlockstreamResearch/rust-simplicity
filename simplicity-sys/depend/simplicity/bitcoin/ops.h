 ...
 */
sha256_midstate rustsimplicity_0_8_bitcoin_make_tapleaf(unsigned char version, const sha256_midstate* cmr);
 ...
 *               NULL != b;
 */
sha256_midstate rustsimplicity_0_8_bitcoin_make_tapbranch(const sha256_midstate* a, const sha256_midstate* b);
