 ...
 */
size_t rustsimplicity_0_7_bitcoin_mallocBoundVars(unification_var** bound_var, size_t* word256_ix, size_t* extra_var_start, size_t extra_var_len) {
 ...
 *               NULL != stream
 */
simplicity_err rustsimplicity_0_7_bitcoin_decodeJet(dag_node* node, bitstream* stream) {
  jetName name;
