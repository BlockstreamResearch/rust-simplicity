 ...
 */
static bool rustsimplicity_0_8_gej_is_valid_var(const secp256k1_gej *a) {
...
bool rustsimplicity_0_8_fe_normalize(frameItem* dst, frameItem src, const txEnv* env) {
...
bool rustsimplicity_0_8_fe_negate(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_fe_add(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_fe_square(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_fe_multiply(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_fe_multiply_beta(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_fe_invert(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_fe_square_root(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_fe_is_zero(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_fe_is_odd(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_scalar_normalize(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_scalar_negate(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_scalar_add(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_scalar_square(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_scalar_multiply(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_scalar_multiply_lambda(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_scalar_invert(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_scalar_is_zero(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_infinity(frameItem* dst, frameItem src, const txEnv* env) {
...
bool rustsimplicity_0_8_gej_rescale(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_normalize(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_negate(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_ge_negate(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_double(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_add(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_ge_add_ex(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_ge_add(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_is_infinity(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_equiv(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_ge_equiv(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_x_equiv(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_y_is_odd(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_gej_is_on_curve(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;

  secp256k1_gej a;
  read_gej(&a, &src);
  writeBit(dst, rustsimplicity_0_8_gej_is_valid_var(&a));
  return true;
}

bool rustsimplicity_0_8_ge_is_on_curve(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_off_curve_scale(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_scale(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
  ...
  read_scalar(&na, &src);
  read_gej(&a, &src);
  if (rustsimplicity_0_8_gej_is_valid_var(&a)) {
    secp256k1_ecmult(&r, &a, &na, &ng);
    write_gej(dst, &r);
    return true;
  } else {
...
bool rustsimplicity_0_8_generate(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_off_curve_linear_combination_1(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_linear_combination_1(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_linear_verify_1(frameItem* dst, frameItem src, const txEnv* env) {
...
bool rustsimplicity_0_8_decompress(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_point_verify_1(frameItem* dst, frameItem src, const txEnv* env) {
  (void) dst; // dst is unused;
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_bip_0340_verify(frameItem* dst, frameItem src, const txEnv* env) {
  (void) dst; // dst is unused;
  (void) env; // env is unused;
...
bool rustsimplicity_0_8_check_sig_verify(frameItem* dst, frameItem src, const txEnv* env) {
  (void) dst; // dst is unused;
  (void) env; // env is unused;
...
/* swu : FE |- GE */
bool rustsimplicity_0_8_swu(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
  secp256k1_fe t;
  secp256k1_ge ge;
  read_fe(&t, &src);
...
bool rustsimplicity_0_8_hash_to_curve(frameItem* dst, frameItem src, const txEnv* env) {
  (void) env; // env is unused;
 ...
 */
bool rustsimplicity_0_8_generic_taptweak(frameItem* dst, frameItem *src, const unsigned char *tagName, size_t tagLen) {
  unsigned char buf[32];
