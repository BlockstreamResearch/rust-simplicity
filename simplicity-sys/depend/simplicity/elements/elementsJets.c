...
static void prevOutpoint(frameItem* dst, const outpoint* op) {
  ...
  rustsimplicity_0_5_write32(dst, op->ix);
}
...
static void amt(frameItem* dst, const confAmount* amt) {
  if (writeBit(dst, EXPLICIT == amt->prefix)) {
    ...
    rustsimplicity_0_5_write64(dst, amt->explicit);
  } else {
...
bool rustsimplicity_0_5_version(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  rustsimplicity_0_5_write32(dst, env->tx->version);
  return true;
}
...
bool rustsimplicity_0_5_input_sequence(frameItem* dst, frameItem src, const txEnv* env) {
  uint_fast32_t i = rustsimplicity_0_5_read32(&src);
  if (writeBit(dst, i < env->tx->numInputs)) {
    rustsimplicity_0_5_write32(dst, env->tx->input[i].sequence);
  } else {
    skipBits(dst, 32);
  }
  return true;
...
bool rustsimplicity_0_5_output_null_datum(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  if (writeBit(dst, i < env->tx->numOutputs && env->tx->output[i].isNullData)) {
    uint_fast32_t j = rustsimplicity_0_5_read32(&src);
    if (writeBit(dst, j < env->tx->output[i].pnd.len)) {
      if (writeBit(dst, OP_PUSHDATA4 < env->tx->output[i].pnd.op[j].code)) {
        ...
        if (writeBit(dst, OP_1 <= env->tx->output[i].pnd.op[j].code)) {
          ...
          rustsimplicity_0_5_debug_assert(OP_RESERVED == env->tx->output[i].pnd.op[j].code ||
...
bool rustsimplicity_0_5_total_fee(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  rustsimplicity_0_5_write64(dst, lookup_fee(&assetid, env->tx->feeOutputs, env->tx->numFees));
  return true;
}
...
bool rustsimplicity_0_5_current_index(frameItem* dst, frameItem src, const txEnv* env) {
  (void) src; // src is unused;
  rustsimplicity_0_5_write32(dst, env->ix);
  return true;
}
...
bool rustsimplicity_0_5_current_sequence(frameItem* dst, frameItem src, const txEnv* env) {
  (void) src; // src is unused;
  if (env->tx->numInputs <= env->ix) return false;
  rustsimplicity_0_5_write32(dst, env->tx->input[env->ix].sequence);
  return true;
}
...
bool rustsimplicity_0_5_num_inputs(frameItem* dst, frameItem src, const txEnv* env) {
  (void) src; // src is unused;
  rustsimplicity_0_5_write32(dst, env->tx->numInputs);
  return true;
}
...
bool rustsimplicity_0_5_num_outputs(frameItem* dst, frameItem src, const txEnv* env) {
  (void) src; // src is unused;
  rustsimplicity_0_5_write32(dst, env->tx->numOutputs);
  return true;
}
...
bool rustsimplicity_0_5_tx_lock_height(frameItem* dst, frameItem src, const txEnv* env) {
  (void) src; // src is unused;
  rustsimplicity_0_5_write32(dst, lockHeight(env->tx));
  return true;
}
...
bool rustsimplicity_0_5_tx_lock_time(frameItem* dst, frameItem src, const txEnv* env) {
  (void) src; // src is unused;
  rustsimplicity_0_5_write32(dst, lockTime(env->tx));
  return true;
}
...
bool rustsimplicity_0_5_tx_lock_distance(frameItem* dst, frameItem src, const txEnv* env) {
  (void) src; // src is unused;
  rustsimplicity_0_5_write16(dst, lockDistance(env->tx));
  return true;
}
...
bool rustsimplicity_0_5_tx_lock_duration(frameItem* dst, frameItem src, const txEnv* env) {
  (void) src; // src is unused;
  rustsimplicity_0_5_write16(dst, lockDuration(env->tx));
  return true;
}
...
bool rustsimplicity_0_5_check_lock_height(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  uint_fast32_t x = rustsimplicity_0_5_read32(&src);
...
bool rustsimplicity_0_5_check_lock_distance(frameItem* dst, frameItem src, const txEnv* env) {
  (void) dst; // dst is unused;
  uint_fast16_t x = rustsimplicity_0_5_read16(&src);
...
bool rustsimplicity_0_5_calculate_issuance_entropy(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  op.ix = rustsimplicity_0_5_read32(&src);
  read32s(contract.s, 8, &src);

  result = rustsimplicity_0_5_generateIssuanceEntropy(&op, &contract);
...
bool rustsimplicity_0_5_calculate_asset(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  result = rustsimplicity_0_5_calculateAsset(&entropy);
...
bool rustsimplicity_0_5_calculate_explicit_token(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  read32s(entropy.s, 8, &src);
  result = rustsimplicity_0_5_calculateToken(&entropy, EXPLICIT);
...
bool rustsimplicity_0_5_calculate_confidential_token(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  read32s(entropy.s, 8, &src);
  result = rustsimplicity_0_5_calculateToken(&entropy, EVEN_Y /* ODD_Y would also work. */);
...
bool rustsimplicity_0_5_build_tapleaf_simplicity(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  sha256_midstate cmr;
  readHash(&cmr, &src);
  sha256_midstate result = rustsimplicity_0_5_make_tapleaf(0xbe, &cmr);
  writeHash(dst, &result);
  return true;
}
...
bool rustsimplicity_0_5_build_tapbranch(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  sha256_midstate result = rustsimplicity_0_5_make_tapbranch(&a, &b);
  writeHash(dst, &result);
  return true;
}
...
bool rustsimplicity_0_5_build_taptweak(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  return rustsimplicity_0_5_generic_taptweak(dst, &src, taptweak, sizeof(taptweak)-1);
}
...
bool rustsimplicity_0_5_output_hash(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  if (writeBit(dst, i < env->tx->numOutputs)) {
    ...
    rustsimplicity_0_5_sha256_confAsset(&ctx, &output->asset);
    rustsimplicity_0_5_sha256_confAmt(&ctx, &output->amt);
    rustsimplicity_0_5_sha256_confNonce(&ctx, &output->nonce);
...
bool rustsimplicity_0_5_input_utxo_hash(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  if (writeBit(dst, i < env->tx->numInputs)) {
    ...
    sha256_midstate midstate;
    sha256_context ctx = sha256_init(midstate.s);
    rustsimplicity_0_5_sha256_confAsset(&ctx, &txo->asset);
    rustsimplicity_0_5_sha256_confAmt(&ctx, &txo->amt);
...
bool rustsimplicity_0_5_issuance_hash(frameItem* dst, frameItem src, const txEnv* env) {
  ...
  if (writeBit(dst, i < env->tx->numInputs)) {
    ...
    if (NO_ISSUANCE == issuance->type) {
      ...
      rustsimplicity_0_5_sha256_confAsset(&ctx, &(confidential){ .prefix = EXPLICIT, .data = issuance->assetId});
      rustsimplicity_0_5_sha256_confAmt(&ctx, &issuance->assetAmt);
      rustsimplicity_0_5_sha256_confAsset(&ctx, &(confidential){ .prefix = EXPLICIT, .data = issuance->tokenId});
      rustsimplicity_0_5_sha256_confAmt(&ctx, NEW_ISSUANCE == issuance->type
                                         ? &issuance->tokenAmt
