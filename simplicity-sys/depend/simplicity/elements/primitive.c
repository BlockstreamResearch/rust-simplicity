 ...
 */
size_t rustsimplicity_0_8_elements_mallocBoundVars(unification_var** bound_var, size_t* word256_ix, size_t* extra_var_start, size_t extra_var_len) {
  ...
  rustsimplicity_0_8_assert(extra_var_len <= 6*DAG_LEN_MAX);
  *bound_var = rustsimplicity_0_8_malloc((NumberOfTypeNames + extra_var_len) * sizeof(unification_var));
 ...
 *               NULL != stream
 */
simplicity_err rustsimplicity_0_8_elements_decodeJet(dag_node* node, bitstream* stream) {
  jetName name;
