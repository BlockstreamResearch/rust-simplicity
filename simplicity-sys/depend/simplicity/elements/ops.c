 ...
 *               NULL != conf;
 */
void rustsimplicity_0_8_sha256_confidential(unsigned char evenPrefix, unsigned char oddPrefix, sha256_context* ctx, const confidential* conf) {
  switch (conf->prefix) {
 ...
 *               NULL != asset;
 */
void rustsimplicity_0_8_sha256_confAsset(sha256_context* ctx, const confidential* asset) {
  rustsimplicity_0_8_sha256_confidential(0x0a, 0x0b, ctx, asset);
}
 ...
 *               NULL != nonce;
 */
void rustsimplicity_0_8_sha256_confNonce(sha256_context* ctx, const confidential* nonce) {
  rustsimplicity_0_8_sha256_confidential(0x02, 0x03, ctx, nonce);
}
 ...
 *               NULL != amt;
 */
void rustsimplicity_0_8_sha256_confAmt(sha256_context* ctx, const confAmount* amt) {
  switch (amt->prefix) {
 ...
 *               NULL != contract;
 */
sha256_midstate rustsimplicity_0_8_generateIssuanceEntropy(const outpoint* op, const sha256_midstate* contract) {
  uint32_t block[16];
 ...
 */
sha256_midstate rustsimplicity_0_8_calculateAsset(const sha256_midstate* entropy) {
  uint32_t block[16] = {0};
  sha256_midstate result;
 ...
 * Precondition: NULL != entropy;
 */
sha256_midstate rustsimplicity_0_8_calculateToken(const sha256_midstate* entropy, confPrefix prefix) {
  uint32_t block[16] = {0};
  sha256_midstate result;
 ...
 */
sha256_midstate rustsimplicity_0_8_make_tapleaf(unsigned char version, const sha256_midstate* cmr) {
  sha256_midstate result;
 ...
 *               NULL != b;
 */
sha256_midstate rustsimplicity_0_8_make_tapbranch(const sha256_midstate* a, const sha256_midstate* b) {
  sha256_midstate result;
