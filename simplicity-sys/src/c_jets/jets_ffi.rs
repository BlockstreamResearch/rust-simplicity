...
extern "C" {
    ...
    pub fn bitcoin_annex_hash(
        dst: *mut CFrameItem,
        src: *const CFrameItem,
        env: *const bitcoin::CTxEnv,
    ) -> bool;
