...
extern "C" {
    ...
    pub(crate) fn c_initWriteFrame(frame: &mut CFrameItem, n: size_t, from: *const c_uchar);
    pub(crate) fn c_initReadFrame(frame: &mut CFrameItem, n: size_t, from: *const c_uchar);
