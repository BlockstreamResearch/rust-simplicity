...
/// Identifiers of all possible Bitcoin jets
...
pub const VERSION: JetNode<Bitcoin> = JetNode {
    ...
    cmr: Cmr(Midstate([
        0xeb, 0xa0, 0x5b, 0xe6, 0x60, 0xd9, 0x9d, 0xa6, 0x0b, 0xbd, 0xd4, 0xfe, 0x72, 0x23, 0xe1,
        0x0b, 0x79, 0x67, 0x75, 0x62, 0xfc, 0xb6, 0xab, 0xd9, 0x84, 0xae, 0xcf, 0xf5, 0xda, 0xe9,
        0xaa, 0x79,
    ])),
...
pub const LOCK_TIME: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::LockTime,
    cmr: Cmr(Midstate([
        0x0f, 0x45, 0xe8, 0x46, 0x79, 0xe5, 0xf5, 0x33, 0x81, 0xb6, 0x97, 0x1f, 0x95, 0x81, 0x26,
        0x6f, 0x58, 0x4c, 0xb9, 0xd0, 0x76, 0xf4, 0x5b, 0x7b, 0xed, 0xad, 0x9d, 0x4f, 0x3e, 0x04,
        0x43, 0x0c,
    ])),
    source_ty: TypeName(b"1"),
    target_ty: TypeName(b"i"),
...
pub const INPUTS_HASH: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::InputsHash,
    cmr: Cmr(Midstate([
        0x0f, 0xa9, 0xbf, 0xa7, 0x71, 0x84, 0x89, 0x0a, 0xd9, 0x2f, 0xfc, 0x45, 0x8e, 0x42, 0x19,
        0xa4, 0xa5, 0x3d, 0x1e, 0x98, 0x53, 0x0c, 0xe0, 0xd0, 0xdc, 0x9e, 0x00, 0x0c, 0x33, 0x9a,
        0xd9, 0xab,
    ])),
    source_ty: TypeName(b"1"),
...
pub const OUTPUTS_HASH: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::OutputScriptHash,
    cmr: Cmr(Midstate([
        0x45, 0x9a, 0x08, 0xe7, 0x6b, 0x75, 0x19, 0x37, 0xd8, 0x02, 0x2f, 0xef, 0xe4, 0x11, 0xba,
        0xb2, 0x62, 0xd7, 0xa1, 0xdd, 0x4b, 0x71, 0x61, 0x09, 0x63, 0x87, 0x17, 0xe2, 0x19, 0x19,
        0x96, 0x21,
    ])),
    source_ty: TypeName(b"1"),
    target_ty: TypeName(b"h"),
...
pub const CURRENT_VALUE: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::CurrentValue,
    cmr: Cmr(Midstate([
        0xcf, 0x34, 0x62, 0x80, 0xec, 0xb3, 0x9f, 0x59, 0x1d, 0x12, 0x15, 0xc9, 0x3b, 0x08, 0x66,
        0x43, 0x70, 0x3b, 0x16, 0x24, 0x49, 0x97, 0xe6, 0x73, 0xf7, 0x13, 0xf9, 0x40, 0x63, 0x69,
        0x82, 0x98,
    ])),
    source_ty: TypeName(b"1"),
...
pub const CURRENT_SEQUENCE: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::CurrentSequence,
    cmr: Cmr(Midstate([0; 32])),
    source_ty: TypeName(b"1"),
    target_ty: TypeName(b"i"),
};

pub const CURRENT_INDEX: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::CurrentIndex,
    cmr: Cmr(Midstate([
        0xd8, 0x7a, 0x1f, 0x6d, 0x73, 0x91, 0x1d, 0xcb, 0x6f, 0x58, 0x20, 0xf6, 0x2a, 0xe3, 0x85,
        0xae, 0x65, 0x90, 0x17, 0x0f, 0x84, 0xe7, 0x51, 0x68, 0x41, 0xda, 0x5a, 0x17, 0xcb, 0x50,
        0x94, 0xe7,
    ])),
    source_ty: TypeName(b"1"),
    target_ty: TypeName(b"i"),
...
// Core macros
pub const ADD32: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::Add32,
    cmr: Cmr(Midstate([
...
pub const FULL_ADD32: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::FullAdd32,
    cmr: Cmr(Midstate([
...
pub const SUB32: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::Sub32,
    cmr: Cmr(Midstate([
...
pub const FULL_SUB32: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::FullSub32,
    cmr: Cmr(Midstate([
...
pub const MUL32: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::Mul32,
    cmr: Cmr(Midstate([
...
pub const FULL_MUL32: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::FullMul32,
    cmr: Cmr(Midstate([
...
pub const EQ32_VERIFY: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::Eq32Verify,
    cmr: Cmr(Midstate([
...
pub const EQ256_VERIFY: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::Eq256Verify,
    cmr: Cmr(Midstate([
...
pub const LT32_VERIFY: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::Lt32Verify,
    cmr: Cmr(Midstate([
...
pub const SHA256: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::Sha256,
    cmr: Cmr(Midstate([
...
pub const SHA256_BLOCK: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::Sha256Block,
    cmr: Cmr(Midstate([
...
pub const BIP_0340_VERIFY: JetNode<Bitcoin> = JetNode {
    name: BitcoinJetName::Bip0340Verify,
    cmr: Cmr(Midstate([
