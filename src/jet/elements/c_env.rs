...
fn new_raw_output(out: &elements::TxOut, out_data: &CRawOutputData) -> CRawOutput {
    unsafe {
...
fn new_tx_data(tx: &elements::Transaction, in_utxos: &[ElementsUtxo]) -> CRawTransactionData {
    let mut tx_data = CRawTransactionData {
