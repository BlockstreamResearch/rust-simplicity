...
impl Amr {
    ...
    pub fn iden(ty: &FinalArrow) -> Self {
        let a = &ty.source;
        Self::IDEN_IV.update_0_then_32(a.tmr()).into_merkle_root()
    }

    /// Produce a CMR for a unit combinator
    pub fn unit(ty: &FinalArrow) -> Self {
        let a = &ty.source;
        Self::UNIT_IV.update_0_then_32(a.tmr()).into_merkle_root()
    }
    ...
    pub fn injl(ty: &FinalArrow, child: Amr) -> Self {
        ...
        Self::INJL_IV
            .zz_update_2x32(a.tmr(), b.tmr())
            .zz_update_2x32(c.tmr(), child)
            .into_merkle_root()
    }
    ...
    pub fn comp(ty: &FinalArrow, left_arrow: &FinalArrow, left: Amr, right: Amr) -> Self {
        ...
        let c = &ty.target;
        Self::COMP_IV
            .update_0_then_32(a.tmr())
            .zz_update_2x32(b.tmr(), c.tmr())
            .zz_update_2x32(left, right)
            .into_merkle_root()
    }

    fn case_helper(iv: Midstate, ty: &FinalArrow, left: Amr, right: Amr) -> Self {
        let (sum_a_b, c) = ty.source.as_product().unwrap();
        let (a, b) = sum_a_b.as_sum().unwrap();
        let d = &ty.target;
        iv.zz_update_2x32(a.tmr(), b.tmr())
            .zz_update_2x32(c.tmr(), d.tmr())
            .zz_update_2x32(left, right)
            .into_merkle_root()
    }
    ...
    pub fn witness(ty: &FinalArrow, value: &Value) -> Self {
        ...
        Self::WITNESS_IV
            .update_0_then_32(a.tmr())
            .zz_update_2x32(b.tmr(), compact_value(value))
            .into_merkle_root()
    }
    ...
    #[rustfmt::skip]
    const IDEN_IV: Midstate = Midstate([
    ...
    #[rustfmt::skip]
    const INJL_IV: Midstate = Midstate([
    ...
    #[rustfmt::skip]
    const INJR_IV: Midstate = Midstate([
    ...
    #[rustfmt::skip]
    const TAKE_IV: Midstate = Midstate([
    ...
    #[rustfmt::skip]
    const DROP_IV: Midstate = Midstate([
    ...
    #[rustfmt::skip]
    const COMP_IV: Midstate = Midstate([
    ...
    #[rustfmt::skip]
    const CASE_IV: Midstate = Midstate([
    ...
    #[rustfmt::skip]
    const ASSERTL_IV: Midstate = Midstate([
    ...
    #[rustfmt::skip]
    const ASSERTR_IV: Midstate = Midstate([
    ...
    #[rustfmt::skip]
    const PAIR_IV: Midstate = Midstate([
    ...
    #[rustfmt::skip]
    const DISCONNECT_IV: Midstate = Midstate([
    ...
    #[rustfmt::skip]
    const WITNESS_IV: Midstate = Midstate([
    ...
    #[rustfmt::skip]
    const FAIL_IV: Midstate = Midstate([
