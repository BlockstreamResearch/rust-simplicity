...
impl Cmr {
    ...
    #[rustfmt::skip]
    const JET_IV: Cmr = Cmr(Midstate([
        0xb3, 0xf1, 0x42, 0x91, 0xa2, 0x78, 0x7f, 0xa8,
        0x14, 0xf8, 0x14, 0x66, 0x27, 0x81, 0x56, 0x68,
        0x6d, 0x7d, 0x3f, 0x43, 0x24, 0xe8, 0x1b, 0xd4,
        0x61, 0xab, 0xf4, 0xdd, 0x20, 0x1a, 0xd3, 0xa8,
    ]));
...
mod tests {
    ...
    fn ivs() {
        ...
        check_iv(Cmr::JET_IV, "Simplicity-Draft\x1fJet");
