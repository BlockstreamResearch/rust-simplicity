...
mod tests {
    ...
    fn executed_witness_with_value() {
        ...
        assert_finalize_ok::<Core>(s, &a_less_than_b, &crate::jet::CoreEnv::EMPTY);
    ...
    fn pruned_witness_without_value() {
        ...
        assert_finalize_ok::<Core>(s, &wit2_is_pruned, &crate::jet::CoreEnv::EMPTY);
        ...
        assert_finalize_ok::<Core>(s, &wit2_is_present, &crate::jet::CoreEnv::EMPTY);
    }
    ...
    fn witness_name_override() {
        ...
        assert_finalize_ok::<Core>(s, &wit2_populated, &crate::jet::CoreEnv::EMPTY);
    }
}
